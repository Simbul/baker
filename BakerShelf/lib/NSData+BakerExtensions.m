...
+ (NSData *)bkrDataWithBase64EncodedString:(NSString *)string
{
    const char lookup[] =
    {
...
- (NSString *)bkrBase64EncodedStringWithWrapWidth:(NSUInteger)wrapWidth
{
...
- (NSString *)bkrBase64EncodedString
{
    return [self bkrBase64EncodedStringWithWrapWidth:0];
}
